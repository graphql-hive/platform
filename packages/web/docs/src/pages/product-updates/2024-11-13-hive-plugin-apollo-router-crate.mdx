...
Hive provides a
[drop-in replacement for Apollo-Router binary/Docker image](https://the-guild.dev/graphql/hive/docs/other-integrations/apollo-router)
...
[integration documentation](https://the-guild.dev/graphql/hive/docs/other-integrations/apollo-router).
