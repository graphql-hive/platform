...
[More information on `@urql/exchange-persisted` on the urql documentation](https://formidable.com/open-source/urql/docs/advanced/persistence-and-uploads/))
...
You can also the request path to extract the persisted operation id. This requires you to also
