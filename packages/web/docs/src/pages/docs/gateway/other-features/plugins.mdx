...
It is the very first hook called just before the underlying GraphQL Yoga instance starts listening
for HTTP requests.
...
- `yoga`: the Graphql Yoga `YogaServer` instance that is about to start.
