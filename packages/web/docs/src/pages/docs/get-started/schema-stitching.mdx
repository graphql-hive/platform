...
![Stitching SDL](/docs/pages/guides/stitching-users-schema.png)
...
![Schema Explorer](/docs/pages/guides/stitching-explorer.png)
...
![Schema History](/docs/pages/guides/stitching-history.png)
...
![CDN Token Form](/docs/pages/guides/cdn_token.png)
...
`HIVE_CDN_ENDPOINT` is your Hive CDN endpoint (without the artifact type, just drop the `/sdl` or
