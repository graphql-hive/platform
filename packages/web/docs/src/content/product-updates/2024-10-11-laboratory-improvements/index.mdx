...
export const fullScreenMode = `${process.env.NEXT_BASE_PATH}/full-screen-mode.mp4`
export const queryBuilder = `${process.env.NEXT_BASE_PATH}/query-builder.mp4`
export const newTabs = `${process.env.NEXT_BASE_PATH}/tabs-new.mp4`
