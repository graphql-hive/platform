...
export const fullScreenMode = `${process.env.NEXT_BASE_PATH}/product-updates/full-screen-mode.mp4`
export const queryBuilder = `${process.env.NEXT_BASE_PATH}/product-updates/query-builder.mp4`
export const newTabs = `${process.env.NEXT_BASE_PATH}/product-updates/tabs-new.mp4`
