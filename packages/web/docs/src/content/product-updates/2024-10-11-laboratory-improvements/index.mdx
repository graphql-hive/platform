...
export const newTabs = new URL('./tabs-new.mp4', import.meta.url).href
export const queryBuilder = new URL('./query-builder.mp4', import.meta.url).href
export const fullScreenMode = new URL('./full-screen-mode.mp4', import.meta.url).href
